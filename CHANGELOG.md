...
- `DatePicker` with focus-open behavior that preserves the typing cursor, typed dates, optional local hour/minute selection, direct month navigation, ISO values, keyboard calendar navigation, validation states and a React Native modal adapter.
