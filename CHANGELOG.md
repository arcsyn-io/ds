...
- `@arcsyn-io/presentations` with an AI-ready brief schema, editorial layouts, narrative patterns, visual theme and editable PowerPoint, HTML slide and continuous technical-proposal templates.
