...
/>`,
  ...
  },
  {
    ...
    properties: [
      ...
      { name: "Select.Content.positionerClassName", type: "string", defaultValue: "—", description: "Permite ajustar a camada de posicionamento ao compor o Select dentro de outro overlay." },
      { name: "Select.Content.positionerProps", type: "Select.Positioner props", defaultValue: "—", description: "Configura lado, alinhamento e tratamento de colisões da lista." },
