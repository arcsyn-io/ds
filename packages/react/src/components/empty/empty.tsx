...
export const EmptyTitle = forwardRef<HTMLHeadingElement, HTMLAttributes<HTMLHeadingElement>>(function EmptyTitle({ className, children, ...props }, ref) { return <h3 ref={ref} className={cx("arcsyn-empty__title", className)} {...props}>{children}</h3>; });
